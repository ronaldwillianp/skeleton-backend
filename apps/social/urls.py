...
from .viewsets import CategoriaNoticiaViewSet, EstadoNoticiaViewSet, NoticiaViewSet, EstadoComentarioViewSet, ComentarioNoticiaViewSet, FAQViewSet, EnlacesInteresViewSet, CategoriaEnlaceInteresViewSet
...
router.register('comentario_noticia', ComentarioNoticiaViewSet)
